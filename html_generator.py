...
<html>
	<head>
<meta charset="UTF-8">
		<title>Stage 2:Automate Your Page</title>		
		<link rel="stylesheet" type="text/css" href="stage2.css">
		</head>  <h1>Matt's Notes<br>Stage 2:Automate Your Page</h1>
<div class="concept">
...
<div class="concept">
    <div class="concept-title">
        Selecting subsequences of strings
    </div>
    <div class="concept-notes">
...
<div class="concept">
    <div class="concept-title">
        Finding strings within strings using .find
    </div>
    <div class="concept-notes">
...
<div class="concept">
    <div class="concept-title">
        Finding strings with a starting position
    </div>
    <div class="concept-notes">
...
<div class="concept">
    <div class="concept-title">
        Control Flows and Loops: if and while
    </div>
    <div class="concept-notes">
...
<div class="concept">
    <div class="concept-title">
        Structured Data: Lists and For Loop
    </div>
    <div class="concept-notes">
